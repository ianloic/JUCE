...
function(juce_add_module module_path)
    ...
    elseif((CMAKE_SYSTEM_NAME STREQUAL "Linux") OR (CMAKE_SYSTEM_NAME MATCHES ".*BSD"))
        ...
        if(JUCE_USE_WAYLAND)
            if("gl" IN_LIST module_linuxpackages)
                list(REMOVE_ITEM module_linuxpackages "gl")
                if("${module_name}" STREQUAL "juce_opengl")
                    list(APPEND module_linuxpackages "wayland-egl" "egl" "glesv2")
                endif()
            endif()
        endif()
